                                  ...
                                  <div class="row">
                                      <div class="col-md-6">
                                          <div class="form-floating my-3">
                                              ...
                                              <label for="name">Full Name <code class="text-dangers">*</code></label>
                                              @error('name')
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-floating my-3">
                                              ...
                                              <label for="phone">Phone Number <code class="text-dangers">*</code></label>
                                              @error('phone')
                                                  <span class="text-danger">{{ $message }}</span>
                                              @enderror
                                          </div>
                                      ...
                                      <div class="col-md-4">
                                          <div class="form-floating my-3">
                                              ...
                                              <label for="city">Town / City <code class="text-dangers">*</code></label>
                                              @error('city')
                                                  <span class="text-danger">{{ $message }}</span>
                                              @enderror
                                          </div>
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-floating my-3">
                                              ...
                                              <label for="address">House no, Building Name <code class="text-dangers">*</code></label>
                                              @error('address')
                                                  <span class="text-danger">{{ $message }}</span>
                                              @enderror
                                          </div>
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-floating my-3">
                                              ...
                                              <label for="locality">Road Name, Area, Colony <code class="text-dangers">*</code></label>
                                              @error('locality')
                                                  <span class="text-danger">{{ $message }}</span>
                                              @enderror
                                          </div>
                                      ...
                                      <div class="col-md-12">
                                          <div class="form-floating my-3">
                                              ...
                                              <label for="landmark">Landmark <code class="text-dangers">*</code></label>
                                              @error('landmark')
                                                  <span class="text-danger">{{ $message }}</span>
                                              @enderror
                                          </div>
