              ...
              <div class="accordion-body px-0 pb-0 pt-3 category-list">
                <ul class="list list-inline mb-0">
                    @foreach ($categories as $category)
                        <li class="list-item">
                           <span class="munu-link py-1">
                            <input type="checkbox" class="ck-category" name="categories" value="{{$category->id}}"
                        ...
                        <div class="d-flex flex-wrap">
                            <form id="color-filter-form">
                                ...
                                @foreach ($colors as $color)
                                    <a href="#" class="swatch-color js-filter"
                                    style="color: {{ $color->SKU }}; width: 30px; height: 30px; display: inline-block; border-radius: 50%; margin: 5px; border: 2px solid #ddd;"
                                    data-color="{{ $color->SKU }}">
                                    </a>
                                @endforeach
                            </form>
                        </div>
              ...
              <div class="search-field multi-select accordion-body px-0 pb-0">
                <ul class="list list-inline mb-0 brand-list">
                    @foreach ($brands as $brand)
                        <li class="list-item">
                            <span class="munu-link py-1">
                                <input type="checkbox" class="ck-brand" name="brands" value="{{$brand->id}}"
      ...
      <div class="shop-list flex-grow-1">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" style="margin-right: 20px;" aria-label="Page Size"
          ...
          <div class="product-card-wrapper">
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    ...
                    <a href="{{ route('shop.details', ['product_slug'=> $product->slug]) }}"><img loading="lazy" src="{{ asset('uploads/products')}}/{{ $img}}"
              ...
              <div class="pc__info position-relative">
                <p class="pc__category">{{ $product->name }}</p>
                <h6 class="pc__title"><a href="{{ route('shop.details', ['product_slug'=> $product->slug]) }}">{{ $product->description }}</a></h6>
                <div class="product-card__price d-flex">
                  <span class="money price">
                    @if($product->price)
                       <s>${{ $product->cost }}</s><span style="color: red;">${{ $product->price }}</span>
                    @else
                      ${{ $product->price }}
                    @endif
                </span>
...
<script>
    $(function() {
        ...
        $(document).ready(function () {
            ...
            let currentColors = $("#SKU").val() ? $("#SKU").val().split(",") : [];

            if (currentColors.includes(selectedColor)) {
                currentColors = currentColors.filter(color => color !== selectedColor);
