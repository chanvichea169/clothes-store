...
<main class="pt-90">
    ...
    <section class="login-register container">
        <ul class="nav nav-tabs mb-5 justify-content-center" id="login_register" role="tablist">
        ...
        <div class="tab-content pt-2" id="login_register_tab_content">
            <div class="tab-pane fade show active" id="tab-item-register" role="tabpanel" aria-labelledby="register-tab">
                <div class="register-form mx-auto" style="max-width: 400px;">
                    <form method="POST" action="{{ route('register') }}" name="register-form" class="needs-validation" novalidate="">
                        ...
                        <div class="customer-option mt-4 text-center">
                            ...
                            <a href="{{ route('login') }}" class="btn-text text-primary">Login to your Account</a>
                        </div>
                    </form>
                </div>
            </div>
