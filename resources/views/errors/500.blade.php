...
<section class="error-container">
    ...
    <svg class="floating floating-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M19 13H13V19H11V13H5V11H11V5H13V11H19V13Z" fill="#D946EF"/>
    </svg>

    <svg class="floating floating-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M12 4L10.59 5.41L16.17 11H4V13H16.17L10.59 18.59L12 20L20 12L12 4Z" fill="#EF4444"/>
    </svg>
    ...
    <div class="error-content">
        ...
        <div class="illustration">
            <img src="{{ asset('assets/images/500.png') }}" alt="Internal server error" />
        </div>
