    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            ...
            <form
                ...
                action="{{ route('admin.update.brand') }}"
                method="POST"
                enctype="multipart/form-data"
            >
                @method('PUT')
                @csrf
                <input type="hidden" name="id" value="{{ $brand->id }}" hidden>
                <fieldset class="name">
                ...
                @enderror
                    <fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            @if ($brand->logo)
                            <div class="item" id="imgpreview" style="{{ $brand->logo ? 'display:block' : 'display:none' }}">
                                <img src="{{ asset('uploads/brands/' . $brand->logo) }}" class="effect8" alt="" aria-required="">
                            </div>
                            @endif
